...
Route::post('/incoming/message', 'IncomingController@recesive');
Route::post('/webhook/vonage', 'Admin\MessageController@receive')->name('webhook.vonage');
...
Route::post('/auth/social-login', 'Api\SocialLoginController@socialLogin');
