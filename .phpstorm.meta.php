...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\programming\programs\venusnapback\public\storage' => 'string',
            ...
            'logging.channels.s3.driver' => 'string',
            'logging.channels.s3.key' => 'NULL',
            'logging.channels.s3.secret' => 'NULL',
            'logging.channels.s3.region' => 'NULL',
            'logging.channels.s3.bucket' => 'NULL',
            'logging.channels.s3.path' => 'string',
            'logging.channels.s3.level' => 'string',
...
'app.aliases.Vite','app.default_cover_url','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
'auth.guards.web.provider','auth.guards.api.driver','auth.guards.api.provider','auth.guards.api.hash','auth.guards.sanctum.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.E:\\programming\\programs\\venusnapback\\public\\storage','fortify.guard','fortify.middleware',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.s3.driver',
'logging.channels.s3.key','logging.channels.s3.secret','logging.channels.s3.region','logging.channels.s3.bucket','logging.channels.s3.path',
'logging.channels.s3.level','logging.channels.deprecations.driver','logging.channels.deprecations.handler','mail.default','mail.mailers.smtp.transport',
...
'services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.firebase.credentials','services.firebase.project_id',
'services.firebase.server_key','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'firebase.projects.app.http_client_options.proxy','firebase.projects.app.http_client_options.timeout','firebase.projects.app.http_client_options.guzzle_middlewares','livewire.class_namespace','livewire.view_path',
...
'signed','throttle','verified','admin','check.account.status',);
...
'livewire.update','livewire.upload-file','livewire.preview-file','dashboard',
'storage.local',);
        registerArgumentsSet('views', 
'admin.ads.adboards','admin.ads.index','admin.albums.index','admin.categories.albumindex','admin.categories.index',
'admin.comments.comment','admin.comments.replies','admin.inc.footer','admin.inc.header','admin.inc.sidebar',
'admin.payments.index','admin.points.manage.allocations','admin.points.manage.create','admin.points.transactions.index','admin.posts.index',
'admin.posts.show','admin.recommendations.index','admin.saved.index','admin.template.create','admin.template.index',
'admin.tickets.index','admin.userauth.sessions','admin.users.index','admin.users.show','admin.verification.create',
'admin.verification.index','admin.welcome','api.api-token-manager','api.index','auth.confirm-password',
...
'emails.2fa','emails.team-invitation','layouts.admin','layouts.app','layouts.guest',
'layouts.user','navigation-menu','passport::authorize','policy','profile.delete-user-form',
...
'terms','user.account.index','user.artwork.create','user.artwork.index','user.includes.footer',
'user.includes.header','user.includes.sidebar','user.post.create','user.post.edit','user.post.index',
'user.reports.create','user.reports.index','user.saved.index','user.welcome','vendor.passport.authorize',
...
'passport::authorize','telescope::layout',);
