    ...
    <div class="container fade-in">
        <div class="header">
            ...
            <div class="album-description">
                @php
                    switch($album->type ?? 'personal') {
                        case 'creator':
                            echo "Explore {$roundedSnapCount} creative snaps and inspiration from this creator.";
                            break;
                        case 'business':
                            echo "Discover {$roundedSnapCount} product snaps and business updates.";
                            break;
                        case 'personal':
                        default:
                            $ownerName = $album->user->name ?? 'Someone';
                            echo "Take a glimpse into {$ownerName}'s personal album with {$roundedSnapCount} memories.";
                            break;
                    }
                @endphp
            </div>
            ...
            <div class="sharing-message">
                @if(isset($share))
                    You have been invited by <strong>{{ $share->user->name }}</strong> to view this album. Download the app to explore all {{ $snapCount }} snaps!
                @else
            ...
            <div class="more-content">
                ...
                <div class="features">
                    <div class="feature">
                        ...
                        <p>Exclusive photo collections</p>
                    </div>
                    <div class="feature">
                        <i class="fas fa-lock"></i>
                        <h3>Private Access</h3>
                        <p>Secure album sharing</p>
                    </div>
                    <div class="feature">
