    ...
    <div class="container fade-in">
        <div class="header">
            ...
            <div class="sharing-message">
                @if(isset($share))
                    You have been invited by <strong>{{ $share->user->name }}</strong> to view this snap. Download the app to see it!
                @else
                    You've been invited to view this snap. Download the app to see it!
                @endif
            </div>
        </div>
