        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18"> Verifications Processes</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($pointmanagement->status == 'completed')
                                            <span class="badge-soft-success font-size-13">Verified</span>
                                        @else ($pointmanagement->status == 'pending')
                                        <span class="badge-soft-warning font-size-13">Took Away</span>
                                        @endif
                                    </td>
                                    <td>
