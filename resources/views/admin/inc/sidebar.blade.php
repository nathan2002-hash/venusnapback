    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/restricted/welcome" class="waves-effect">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-invoices">Admires</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-invoice-list">Admires</a></li>
                        <li><a href="#" key="t-invoice-detail">Demographic</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-projects">Artworks</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-p-grid">Artworks</a></li>
                        <li><a href="#" key="t-p-list">Demographic</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-detail"></i>
                        <span key="t-blog">Views</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-blog-list">Views</a></li>
                        <li><a href="#" key="t-blog-grid">Demographic</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-briefcase-alt-2"></i>
                        <span key="t-projects">Notifications</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-p-grid">Notifications</a></li>
                        <li><a href="#" key="t-p-list">Demographic</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-task-list">Supporters</a></li>
                        <li><a href="#" key="t-kanban-board">Demographic</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bxs-user-detail"></i>
                        <span key="t-contacts">Tags</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-user-grid">Add Tag</a></li>
                        <li><a href="#" key="t-user-list">Tags</a></li>
                        <li><a href="#" key="t-user-list">Post Tags</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-title" key="t-pages">Security</li>
