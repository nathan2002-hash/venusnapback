					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li>
								<ul>
									<li>
										<a href="/restricted/welcome">
											<i class="isax isax-note-215"></i><span>Dashboard</span>
										</a>
									</li>
								</ul>
							</li>
							<li class="menu-title"><span>App Growth</span></li>
							<li>
								<ul>
									<li>
										<a href="/restricted/users">
											<i class="isax isax-lifebuoy5"></i><span>Users</span>
										</a>
									</li>
									<li>
										<a href="/restricted/albums">
											<i class="isax isax-note5"></i><span>Albums</span>
										</a>
									</li>
									<li>
							...
							<li>
								<ul>
									<li class="submenu">
										<a href="javascript:void(0);">
											<i class="isax isax-profile-2user5"></i><span>Sms Compaigns</span>
											<span class="menu-arrow"></span>
										</a>
										<ul>
											<li><a href="/restricted/communication/create">Send Message</a></li>
											<li><a href="/restricted/communications">Messages</a></li>
										</ul>
									</li>
									<li class="submenu">
										<a href="javascript:void(0);">
											<i class="isax isax-star-15"></i><span>Email Compaigns</span>
											<span class="menu-arrow"></span>
										</a>
										<ul>
									...
									<li class="submenu">
										<a href="javascript:void(0);">
											<i class="isax isax-star-15"></i><span>App Compagins</span>
											<span class="menu-arrow"></span>
										</a>
										<ul>
						...
						<div class="sidebar-footer">
                            ...
                            <ul class="menu-list">
                                <li>
                                    <a href="account-settings.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Settings"><i class="isax isax-setting-25"></i></a>
                                </li>
                                <li>
